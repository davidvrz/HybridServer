...
public class XMLConfigurationLoader extends DefaultHandler {
	...
	private boolean http, webservice, numClients, user, password, url;
	  ...
	  public Configuration load(File xmlFile) throws Exception {
			...
			SAXParserImplementation.parseAndValidateWithExternalXSD(xmlFile.getPath(),"configuration.xsd", this);
